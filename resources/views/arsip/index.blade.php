            ...
            <div class="d-flex justify-content-between align-items-center gap-3 mb-4">
                <div>
                    ...
                    <p class="mb-0 text-white-50">
                        Kelola seluruh arsip surat masuk dan surat keluar
                        PTSP MTsN 1 Banyuwangi.
                    </p>
                </div>
            </div>
            <div class="row g-3">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select class="form-select" name="tahun">
                                        ...
                                        <option value="2026" {{ request('tahun') == 2026 ? 'selected' : '' }}>
                                            2026
                                        </option>
                                        ...
                                        <option value="2023" {{ request('tahun') == 2023 ? 'selected' : '' }}>
                                            2023
                                        </option>
                                        <option value="2022" {{ request('tahun') == 2022 ? 'selected' : '' }}>
                                            2022
                                        </option>
                                        <option value="2021" {{ request('tahun') == 2021 ? 'selected' : '' }}>
                                            2021
                                        </option>
                                        <option value="2020" {{ request('tahun') == 2020 ? 'selected' : '' }}>
                                            2020
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-md-6 d-flex align-items-end">
                                    <button type="submit" class="btn arsip-btn-search w-100 text-white">
                                ...
                                <div class="col-12 col-md-6 d-flex align-items-end">
                                    <a href="{{ route('arsip.index') }}" class="btn arsip-btn-reset w-100 text-white">
