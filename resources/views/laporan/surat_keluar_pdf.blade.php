        ...
        <table>
            <tr>
                ...
                <td class="title">
                    ...
                    <p>
                        Jl. Mawar No.35, Lingkungan Mojoroto R, Mojopanggung, Kec. Giri, Kabupaten Banyuwangi, Jawa Timur 68422
                    </p>
                    <p>
                        Email : mtsn1banyuwangi@kemenag.go.id
                    </p>
                </td>
            </tr>
        </table>
        ...
        <tbody>
            @forelse($suratKeluar as $index => $sk)
                <tr>
                    ...
                    <td>{{ $sk->tujuan }}</td>
                    <td>{{ $sk->perihal }}</td>
                    <td style="text-align: center;">{{ $sk->sifat }}</td>
                </tr>
            @empty
                <tr>
