                    ...
                    @forelse($suratKeluar as $index => $sk)
                        <tr>
                            ...
                            <td class="text-center">
                                @if($sk->file_surat)
                                    <a
                                        href="{{ route('surat-keluar.download',$sk->id) }}"
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <a
                                        href="{{ route('surat-keluar.show',$sk->id) }}"
                                    ...
                                    <a
                                        href="{{ route('surat-keluar.edit',$sk->id) }}"
        ...
        <div class="card-footer bg-white border-0">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <small class="text-secondary">
                        Menampilkan
                        <strong>{{ $suratKeluar->firstItem() ?? 0 }}</strong>
                        -
                        <strong>{{ $suratKeluar->lastItem() ?? 0 }}</strong>
                        dari
                        <strong>{{ $suratKeluar->total() }}</strong>
                        data surat keluar.
                    </small>
                </div>
